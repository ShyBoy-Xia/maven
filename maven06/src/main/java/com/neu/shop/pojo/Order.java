...
public class Order {
	...
	public String toString() {
		return "Order [orderid=" + orderid + ", userid=" + userid + ", ordertime=" + ordertime + ", oldprice="
				+ oldprice + ", newprice=" + newprice + ", ispay=" + ispay + ", issend=" + issend + ", isreceive="
				+ isreceive + ", iscomplete=" + iscomplete + ", addressid=" + addressid + ", goodsInfo=" + goodsInfo
				+ ", address=" + address + "]";
	}
