			...
			<div class="module">
				<div class="">
					...
					<div>
						<!--  class="filter"-->
						<a class="fSort"
							href="${pageContext.request.contextPath}/sortProduct?sort=1&keyword=${keyword}">综合</a>
						<a class="fSort"
							href="${pageContext.request.contextPath}/sortProduct?sort=2&keyword=${keyword}">新品</a>
						<a class="fSort"
							href="${pageContext.request.contextPath}/sortProduct?sort=3&keyword=${keyword}">销量</a>
						<a class="fSort" class="fSort-cur"
							href="${pageContext.request.contextPath}/sortProduct?sort=4&keyword=${keyword}">价格升序</a>
						<a class="fSort" class="fSort-cur"
							href="${pageContext.request.contextPath}/sortProduct?sort=5&keyword=${keyword}">价格降序</a>
						<a class="fSort"
							href="${pageContext.request.contextPath}/sortProduct?sort=6&keyword=${keyword}">评分</a>
					</div>
								...
								<li class="data-item-li">
									<div class="to-big">
										<a
											...
											<img src="${pageContext.request.contextPath}/${goods.imagePaths[0].path}"
									...
									<p class="text-right">
										...
										<div>
											销量<span class="redColor boldWord">${goods.volume}</span>
										</div>
										<div>
											评分<span class="redColor boldWord">${goods.score}</span>
										</div>
