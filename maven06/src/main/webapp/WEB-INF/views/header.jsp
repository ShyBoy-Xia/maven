            ...
            <c:if test="${!empty sessionScope.user}">
                <li class="info-a">
                    ...
                    <a href="${pageContext.request.contextPath}/information" style="color: #F22E00">
                        ${sessionScope.user.username}<img class="head avatar avatar-60 photo "width="40" height="40"
                                                                     src="${pageContext.request.contextPath}/${sessionScope.user.image}" alt="">
    ...
    <nav class="navbar navbar-default" id="header-nav-middle">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/main"><!-- <img alt="Brand" style="display: inline-block;" src="./image/tao.jpg" width="20" height="20"> -->
                <span class="logo-word">阿里神神</span></a>
            </div>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="a-color" href="${pageContext.request.contextPath}/ranking">榜单</a></li>
                    ...
                    <li class="dropdown"><a class="a-color" href="${pageContext.request.contextPath}/info/list"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="${pageContext.request.contextPath}/info/list">查看订单</a></li>
                        </ul></li>
                </ul>
