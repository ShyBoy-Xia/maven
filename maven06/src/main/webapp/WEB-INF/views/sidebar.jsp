...
<div class="templatemo-sidebar">
    ...
    <nav class="templatemo-left-nav">
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/comment/show"><i class="fa fa-database fa-fw"></i>评论管理</a></li>
            <li><a href="${pageContext.request.contextPath}/admin/count/show"><i class="fa fa-sliders fa-fw"></i>销量统计</a></li>
