			...
			<div class="row">
						...
						<div id="leftbox">
							<div id="showbox">
								<c:forEach items="${goodsInfo['image']}" var="path">
									<img src="${pageContext.request.contextPath}/${path.path}"
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					...
					<div class="elav_info">
						...
						<div class="new_meta">
							<span class="sku_wrapper big-font"> 类别: <span class="sku">${goodsInfo['cate'].catename}</span>
							</span> <span class="sku_wrapper big-font"> 数量: <span class="sku">${goodsInfo['goods'].num}</span>
							</span> <span class="sku_wrapper big-font"> 销量: <span class="sku">${goodsInfo['goods'].volume}</span>
							</span> <span class="sku_wrapper big-font"> 评分: <span class="sku">${goodsInfo['goods'].score}</span>
							</span>
						</div>

						<div class="new_meta">
							<span class="sku_wrapper big-font"> 优惠: <c:if
									test="${goodsInfo['goods'].activityid != 1}">
																...
																<div id="comment-22" class="comment_container">
																	...
																	<div class="comment-text">
																		...
																		<p class="meta">
																			...
																			: <a
																				href="${pageContext.request.contextPath}/chat?sendto=${comment.userid}"
																				data-original-title="Add to Wishlist"
																				data-toggle="tooltip" class=" big-font"> <i
