        ...
        <div class="module">
            <div class="">
                ...
                <div>
						<!--  class="filter"
						<a class="fSort"
							href="${pageContext.request.contextPath}/sortByCate?sort=1&cate=${cate}&cateid=${cateid}">综合</a>
						<a class="fSort"
							href="${pageContext.request.contextPath}/sortByCate?sort=3&cate=${cate}&cateid=${cateid}">销量</a>
						<a class="fSort" class="fSort-cur"
							href="${pageContext.request.contextPath}/sortByCate?sort=4&cate=${cate}&cateid=${cateid}">价格升序</a>
						<a class="fSort" class="fSort-cur"
							href="${pageContext.request.contextPath}/sortByCate?sort=5&cate=${cate}&cateid=${cateid}">价格降序</a>
						<a class="fSort"
							href="${pageContext.request.contextPath}/sortByCate?sort=6&cate=${cate}&cateid=${cateid}">评分</a>-->
					</div>
                <hr>
